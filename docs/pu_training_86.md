...
tables (`analysis_out/ps_audit/*.csv`) as regenerated by PR #183 (`b84b791`), the timestamp fix
that keeps 354 labels whose timestamps lack fractional seconds. The tables PR #175 first merged
